    ...
    <div class="duety rv">
      <figure class="duet">
        <div class="duet-rama" data-duet>
          ...
          <button class="duet-strzalka duet-strzalka--lewo" type="button" data-duet-krok="-1"
            aria-label="Pokaż rozbudowę przed remontem" disabled>
            <svg viewBox="0 0 10 16" width="10" height="16" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="M8 1 2 8l6 7"/></svg>
          </button>
          <button class="duet-strzalka duet-strzalka--prawo" type="button" data-duet-krok="1"
            aria-label="Pokaż rozbudowę po remoncie">
            <svg viewBox="0 0 10 16" width="10" height="16" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
      ...
      <figure class="duet">
        <div class="duet-rama" data-duet data-duet-zwloka="260">
          ...
          <span class="znacznik po duet-etyk duet-etyk--po">Po</span>
          <button class="duet-strzalka duet-strzalka--lewo" type="button" data-duet-krok="-1"
            aria-label="Pokaż pokój przed wykończeniem" disabled>
            <svg viewBox="0 0 10 16" width="10" height="16" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="M8 1 2 8l6 7"/></svg>
          </button>
          <button class="duet-strzalka duet-strzalka--prawo" type="button" data-duet-krok="1"
            aria-label="Pokaż pokój po wykończeniu">
            <svg viewBox="0 0 10 16" width="10" height="16" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
              <path d="m2 1 6 7-6 7"/></svg>
          </button>
