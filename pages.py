...
def otwarcie(etykieta, tytul, lead, kadr=None, opis=""):
    ...
    """
    tlo = (f'\n  <img class="otwarcie-tlo" data-paralaksa="60" src="img/{kadr}" alt="{opis}" '
...
<header class="scena">
  <img class="scena-tlo" data-paralaksa="100" src="img/hero.jpg" width="1440" height="1300" fetchpriority="high"
...
<figure class="pas pas--duzy">
  <img data-paralaksa="80" src="img/pas-elewacja.jpg" width="2400" height="1029" loading="lazy" decoding="async"
...
<figure class="pas">
  <img data-paralaksa="80" src="img/pas-zielen.jpg" width="1440" height="617" loading="lazy" decoding="async"
